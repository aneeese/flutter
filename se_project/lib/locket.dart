    ...
    return Scaffold(
      ...
      body: Stack(children: <Widget>[
        ...
        Padding(
          ...
          child: Container(
            child: const Text('This beautifully detailed antiqued gold locket hangs from 30 inches of antiqued brass chain. Dimensions are: 1.75 inches (41mm across), recess is about 30mm in diameter.',
              style: TextStyle(
                color: Colors.white,
                fontSize: 18,
                fontFamily: 'Raleway',
